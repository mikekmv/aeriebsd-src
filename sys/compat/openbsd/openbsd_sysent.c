...
const struct sysent openbsd_sysent[] = {
	{ 0, 0, 0,
	    sys_nosys },			/* 0 = syscall */
	...
	{ 3, s(struct sys_write_args), 0,
	    sys_write },			/* 4 = write */
	{ 3, s(struct openbsd_sys_open_args), 0,
	...
	{ 2, s(struct openbsd_sys_link_args), 0,
	    openbsd_sys_link },			/* 9 = link */
	{ 1, s(struct openbsd_sys_unlink_args), 0,
	    openbsd_sys_unlink },		/* 10 = unlink */
	{ 0, 0, 0,
	    sys_nosys },			/* 11 = obsolete execv */
	{ 1, s(struct openbsd_sys_chdir_args), 0,
	    openbsd_sys_chdir },		/* 12 = chdir */
	{ 1, s(struct sys_fchdir_args), 0,
	    sys_fchdir },			/* 13 = fchdir */
	{ 3, s(struct openbsd_sys_mknod_args), 0,
	    openbsd_sys_mknod },		/* 14 = mknod */
	{ 2, s(struct openbsd_sys_chmod_args), 0,
	    openbsd_sys_chmod },		/* 15 = chmod */
	{ 3, s(struct openbsd_sys_chown_args), 0,
	    openbsd_sys_chown },		/* 16 = chown */
	{ 1, s(struct compat_43_sys_obreak_args), 0,
	    compat_43_sys_obreak },		/* 17 = break */
	{ 0, 0, 0,
	    sys_nosys },			/* 18 = obsolete 2.5 ogetfsstat */
	{ 0, 0, 0,
	    sys_nosys },			/* 19 = obsolete olseek */
	{ 0, 0, SY_NOLOCK | 0,
	    sys_getpid },			/* 20 = getpid */
	{ 4, s(struct openbsd_sys_mount_args), 0,
	    openbsd_sys_mount },		/* 21 = mount */
	{ 2, s(struct openbsd_sys_unmount_args), 0,
	...
	{ 2, s(struct openbsd_sys_access_args), 0,
	    openbsd_sys_access },		/* 33 = access */
	{ 2, s(struct openbsd_sys_chflags_args), 0,
	...
	{ 2, s(struct compat_44_sys_osigaltstack_args), 0,
	    compat_44_sys_osigaltstack },	/* 53 = osigaltstack */
	{ 3, s(struct sys_ioctl_args), 0,
	    sys_ioctl },			/* 54 = ioctl */
	{ 1, s(struct sys_reboot_args), 0,
	    sys_reboot },			/* 55 = reboot */
	{ 1, s(struct openbsd_sys_revoke_args), 0,
	    openbsd_sys_revoke },		/* 56 = revoke */
	{ 2, s(struct openbsd_sys_symlink_args), 0,
	    openbsd_sys_symlink },		/* 57 = symlink */
	{ 3, s(struct openbsd_sys_readlink_args), 0,
	    openbsd_sys_readlink },		/* 58 = readlink */
	{ 3, s(struct openbsd_sys_execve_args), 0,
	    openbsd_sys_execve },		/* 59 = execve */
	{ 1, s(struct sys_umask_args), 0,
	    sys_umask },			/* 60 = umask */
	{ 1, s(struct openbsd_sys_chroot_args), 0,
	...
	{ 0, 0, 0,
	    sys_nosys },			/* 65 = obsolete 2.5 omsync */
	{ 0, 0, 0,
	    sys_vfork },			/* 66 = vfork */
	{ 0, 0, 0,
	...
	{ 0, 0, 0,
	    sys_nosys },			/* 85 = obsolete 2.5 swapon */
	...
	{ 2, s(struct openbsd_sys_rename_args), 0,
	...
	{ 2, s(struct sys_flock_args), 0,
	    sys_flock },			/* 131 = flock */
	{ 2, s(struct openbsd_sys_mkfifo_args), 0,
	...
	{ 2, s(struct openbsd_sys_mkdir_args), 0,
	    openbsd_sys_mkdir },		/* 136 = mkdir */
	{ 1, s(struct openbsd_sys_rmdir_args), 0,
	    openbsd_sys_rmdir },		/* 137 = rmdir */
	{ 2, s(struct openbsd_sys_utimes_args), 0,
	    openbsd_sys_utimes },		/* 138 = utimes */
	{ 0, 0, 0,
	...
	{ 0, 0, 0,
	    sys_nosys },			/* 157 = obsolete 2.5 ostatfs */
	{ 0, 0, 0,
	    sys_nosys },			/* 158 = obsolete 2.5 ostatfs */
	{ 0, 0, 0,
	    sys_nosys },			/* 159 = unimplemented */
	{ 0, 0, 0,
	    sys_nosys },			/* 160 = unimplemented */
	{ 2, s(struct openbsd_sys_getfh_args), 0,
	    openbsd_sys_getfh },		/* 161 = getfh */
	{ 0, 0, 0,
	    sys_nosys },			/* 162 = obsolete 0.9 ogetdomainname */
	{ 0, 0, 0,
	    sys_nosys },			/* 163 = obsolete 0.9 osetdomainname */
	{ 0, 0, 0,
	...
	{ 0, 0, 0,
	    sys_nosys },			/* 169 = obsolete 1.0 semsys */
	{ 0, 0, 0,
	    sys_nosys },			/* 170 = obsolete 1.0 msgsys */
	{ 0, 0, 0,
	    sys_nosys },			/* 171 = obsolete 1.0 shmsys */
	{ 0, 0, 0,
	...
	{ 2, s(struct openbsd_sys_pathconf_args), 0,
	...
	{ 4, s(struct sys_lseek_args), 0,
	    sys_lseek },			/* 199 = lseek */
	{ 3, s(struct openbsd_sys_truncate_args), 0,
...
#ifdef SYSVSEM
	{ 0, 0, 0,
	    sys_nosys },			/* 220 = obsolete semctl23 */
	{ 3, s(struct sys_semget_args), 0,
	    sys_semget },			/* 221 = semget */
	{ 0, 0, 0,
	    sys_nosys },			/* 222 = obsolete 3.5 semop */
	{ 0, 0, 0,
	    sys_nosys },			/* 223 = obsolete semconfig */
#else
	{ 0, 0, 0,
...
#ifdef SYSVMSG
	{ 0, 0, 0,
	    sys_nosys },			/* 224 = obsolete msgctl23 */
	...
	{ 3, s(struct sys_shmat_args), 0,
	    sys_shmat },			/* 228 = shmat */
	{ 0, 0, 0,
	    sys_nosys },			/* 229 = obsolete shmctl23 */
	{ 1, s(struct sys_shmdt_args), 0,
	    sys_shmdt },			/* 230 = shmdt */
	{ 0, 0, 0,
	    sys_nosys },			/* 231 = obsolete 3.5 shmget */
#else
	{ 0, 0, 0,
	...
	{ 3, s(struct openbsd_sys_lchown_args), 0,
	...
	{ 3, s(struct sys_msync_args), 0,
	    sys_msync },			/* 256 = msync */
	{ 0, 0, 0,
	    sys_nosys },			/* 257 = obsolete 3.5 __semctl */
	{ 0, 0, 0,
	    sys_nosys },			/* 258 = obsolete 3.5 shmctl */
	{ 0, 0, 0,
	    sys_nosys },			/* 259 = obsolete 3.5 msgctl */
	{ 0, 0, 0,
	...
	{ 0, 0, 0,
	    sys_nosys },			/* 265 = obsolete 3.5 fhstat */
	{ 0, 0, 0,
...
#endif
	{ 2, s(struct openbsd_sys_stat_args), 0,
	    openbsd_sys_stat },			/* 291 = stat */
	{ 2, s(struct sys_fstat_args), 0,
	    sys_fstat },			/* 292 = fstat */
	{ 2, s(struct openbsd_sys_lstat_args), 0,
	    openbsd_sys_lstat },		/* 293 = lstat */
