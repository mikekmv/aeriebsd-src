 ...
 *
 * created from
 *	ABSD: syscalls.master,v 1.8 2011/11/12 18:07:14 mickey Exp 
 */
...
const struct sysent linux_sysent[] = {
	{ 0, 0, 0,
	    sys_nosys },			/* 0 = syscall */
	...
	{ 1, s(struct compat_43_sys_swapon_args), 0,
	    compat_43_sys_swapon },		/* 87 = swapon */
	...
	{ 2, s(struct compat_44_sys_setdomainname_args), 0,
	    compat_44_sys_setdomainname },	/* 121 = setdomainname */
