 ...
 *
 * created from
 *	ABSD: syscalls.master,v 1.7 2010/04/18 14:35:02 mickey Exp 
 */
...
const struct sysent freebsd_sysent[] = {
	{ 0, 0, 0,
	    sys_nosys },			/* 0 = syscall */
	...
	{ 3, s(struct freebsd_sys_ogetfsstat_args), 0,
	    freebsd_sys_ogetfsstat },		/* 18 = ogetfsstat */
	...
	{ 1, s(struct compat_43_sys_swapon_args), 0,
	    compat_43_sys_swapon },		/* 85 = swapon */
	...
	{ 2, s(struct freebsd_sys_ostatfs_args), 0,
	    freebsd_sys_ostatfs },		/* 157 = ostatfs */
	{ 2, s(struct freebsd_sys_ofstatfs_args), 0,
	    freebsd_sys_ofstatfs },		/* 158 = ofstatfs */
	{ 0, 0, 0,
...
#endif
	{ 2, s(struct compat_44_sys_getdomainname_args), 0,
	    compat_44_sys_getdomainname },	/* 162 = getdomainname */
	{ 2, s(struct compat_44_sys_setdomainname_args), 0,
	    compat_44_sys_setdomainname },	/* 163 = setdomainname */
	...
	{ 5, s(struct compat_44_sys_semsys_args), 0,
	    compat_44_sys_semsys },		/* 169 = semsys */
#else
	{ 0, 0, 0,
	    sys_nosys },			/* 169 = unimplemented 1.0 semsys */
#endif
#if defined(SYSVMSG) && !defined(alpha)
	{ 6, s(struct compat_44_sys_msgsys_args), 0,
	    compat_44_sys_msgsys },		/* 170 = msgsys */
#else
	{ 0, 0, 0,
	    sys_nosys },			/* 170 = unimplemented 1.0 msgsys */
#endif
#if defined(SYSVSHM) && !defined(alpha)
	{ 4, s(struct compat_44_sys_shmsys_args), 0,
	    compat_44_sys_shmsys },		/* 171 = shmsys */
#else
	{ 0, 0, 0,
	...
	{ 2, s(struct compat_44_sys_fstat_args), 0,
	    compat_44_sys_fstat },		/* 189 = fstat */
	...
	{ 2, s(struct freebsd_sys_fstatfs_args), 0,
	    freebsd_sys_fstatfs },		/* 397 = fstatfs */
	{ 0, 0, 0,
