...
struct freebsd_sys_ogetfsstat_args {
...
struct freebsd_sys_ostatfs_args {
	syscallarg(char *) path;
	syscallarg(struct freebsd_ostatfs *) buf;
};

struct freebsd_sys_ofstatfs_args {
	syscallarg(int) fd;
	syscallarg(struct freebsd_ostatfs *) buf;
};
...
int	freebsd_sys_ogetfsstat(struct proc *, void *, register_t *);
...
int	freebsd_sys_ostatfs(struct proc *, void *, register_t *);
int	freebsd_sys_ofstatfs(struct proc *, void *, register_t *);
#ifdef NFSCLIENT
