...
const struct sysent sunos_sysent[] = {
	{ 0, 0, 0,
	    sys_nosys },			/* 0 = syscall */
	...
	{ 1, s(struct compat_43_sys_sbrk_args), 0,
	    compat_43_sys_sbrk },		/* 69 = sbrk */
	{ 1, s(struct compat_43_sys_sstk_args), 0,
	    compat_43_sys_sstk },		/* 70 = sstk */
