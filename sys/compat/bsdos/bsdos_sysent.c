 ...
 *
 * created from
 *	ABSD: syscalls.master,v 1.6 2010/02/12 14:25:05 mickey Exp 
 */
...
const struct sysent bsdos_sysent[] = {
	{ 0, 0, 0,
	    sys_nosys },			/* 0 = syscall */
	...
	{ 3, s(struct compat_44_sys_getfsstat_args), 0,
	    compat_44_sys_getfsstat },		/* 18 = getfsstat */
	...
	{ 2, s(struct compat_44_sys_statfs_args), 0,
	    compat_44_sys_statfs },		/* 157 = statfs */
	{ 2, s(struct compat_44_sys_fstatfs_args), 0,
	    compat_44_sys_fstatfs },		/* 158 = fstatfs */
	{ 0, 0, 0,
	...
	{ 2, s(struct compat_44_sys_stat_args), 0,
	    compat_44_sys_stat },		/* 188 = stat44 */
	{ 2, s(struct compat_44_sys_fstat_args), 0,
	    compat_44_sys_fstat },		/* 189 = fstat44 */
	{ 2, s(struct compat_44_sys_lstat_args), 0,
	    compat_44_sys_lstat },		/* 190 = lstat44 */
