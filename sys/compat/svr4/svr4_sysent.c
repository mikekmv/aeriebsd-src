 ...
 *
 * created from
 *	ABSD: syscalls.master,v 1.5 2010/02/12 14:25:06 mickey Exp 
 */
...
const struct sysent svr4_sysent[] = {
	{ 0, 0, 0,
	    sys_nosys },			/* 0 = syscall */
	...
	{ 1, s(struct svr4_sys_setegid_args), 0,
	...
	{ 1, s(struct svr4_sys_fchroot_args), 0,
